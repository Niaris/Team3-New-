...
public class CheckInActivity extends Activity {
	...
	private void getIntentContent() {
		...
		if (Location.getName().isEmpty()) {
			...
			alert.setMessage("Oh, this place is new to us!\nPlease, give a name to it.");
			...
			alert.setPositiveButton("Ok",
					new DialogInterface.OnClickListener() {
						public void onClick(DialogInterface dialog,
							...
							setTitle("Add a Review to " + Location.getName());
						}
					});
			alert.show();
		} else {
	...
	/**
	 * Onclick method for the 'Save Review' button. Adds a review to a location
	 * 
	 * @param view
	 * @return void
	 */
	...
	/**
	 * Onclick method for the 'Browse' button Takes the user to the phone
	 * gallery and allows him to choose an image and upload it.
	 * 
	 * @param view
	 * @return void
	 */
	...
	/**
	 * Creates a ReviewVO based on the fields filled by the user and on the
	 * other information from the application.
	 * 
	...
	private ReviewVO createReviewVO() {
		...
		TextView imagePathArea = (TextView) this
				.findViewById(R.id.imagePathArea);
