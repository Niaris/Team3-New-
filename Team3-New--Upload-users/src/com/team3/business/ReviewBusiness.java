...
public class ReviewBusiness {
	...
	public List<ReviewVO> retrieveReviewsList (int locationID) {
		...
		reviewsList.add(new ReviewVO(new UserVO("Charlie", "charlieBrown@gmail.com"), locationID, 4, "12-10-2013", "12:13", "It is good", ""));
		reviewsList.add(new ReviewVO(new UserVO("Jake", "charlieBrown@gmail.com"), locationID, 5, "12-09-2013", "12:20", "It is bad", ""));
		reviewsList.add(new ReviewVO(new UserVO("Luke", "charlieBrown@gmail.com"), locationID, 1, "12-10-2013", "12:13", "It is great", ""));
		reviewsList.add(new ReviewVO(new UserVO("Jessica", "charlieBrown@gmail.com"), locationID, 3, "12-10-2013", "12:13", "It is awful", ""));
		
		return reviewsList;
	}

	public UserVO getUserByID(int userID) {
		UserVO user = new UserVO("dasdasd", "dasdasd");
		user.setID(userID);
		return user;
	}
